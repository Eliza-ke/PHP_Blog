...
if($cmResult){
  foreach ($cmResult as $key => $value) {
    ...
    $stmtau = $pdo->prepare("SELECT * FROM user WHERE id=$auId"); #show username who comment
    $stmtau->execute();
        ...
        <div class="row">
          <div class="col-md-12">           
              <div class="card-body">
                ...
                <p style="padding:4px;"><?php echo $result[0]['content'] ?></p>
              </div>
              <!-- /.card-body -->
                ...
                <div class="card-comment" >
                  ...
                  <div class="comment-text" style="margin-left: 2px !important">
                    <?php foreach ($cmResult as $key => $value) { ?>
                     <span class="username">
                      <b><?php echo $auResult[$key][0]['name'] ?></b>
